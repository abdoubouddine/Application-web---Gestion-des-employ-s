...
<html lang="en">
  ...
  <div class="container-fluid">
    <h2 style="text-align: center; color: white; font-weight: normal; font-size: 80px;">Click on the button below in order to delete a RH manager</h2> 
     <p>
        <form action="delete2.php" method="POST">
        <input type="text" name="id" placeholder="Enter a valid id">
      <div class="row center">
          <input name="supprimer" class="btn btn-primary" type="submit" value="DELETE">
      </div>
      </form>
      </p>    
    <div class="line"></div>
