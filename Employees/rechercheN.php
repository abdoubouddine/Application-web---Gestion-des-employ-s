...
<body>
	...
	?>
					<h2 class="home-title"> Search by Name :</h2>
					<div class="row center">
						<form action="requete_recherche_N.php" method="POST">
						<div class="row">
							<label class="az" style="color: orange; font-size: 30px;">Name : </label>
							<input type="text" required="required" name="nom" class="az" placeholder="Enter a Name" maxlength="10" pattern="[a-zA-Z]*">
						</div>
						<div class="row">
							<input class="btn btn-primary" name="chercher" value="Submit" type="submit">
