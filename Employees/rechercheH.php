...
<body>
	...
	?>
					<h2 class="home-title"> Search by Number of Hours :</h2>
					<div class="row center">
						<form action="requete_recherche_H.php" method="POST">
						<div class="row">
							<label class="az" style="color: orange; font-size: 30px;">N_Hours : </label>
							<input type="text" required="required" name="nbh" class="az" placeholder="Enter a number of hours" maxlength="5" pattern="[0-9]*">
						</div>
						<div class="row">
