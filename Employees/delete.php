...
<body>
	...
	<section class="sections home text-center">
		<div class="overlay">
			<div class="container">
				<div class="card">
					<h2 class="home-title"> Enter a valid ID below in order to delete:</h2>
					<div class="row">
							<form method="POST" action="delete1.php">
								<label style="font-size:x-large;">ID :</label>
								<input type="text" required="required" id="I" pattern="[0-9]*" name="id">
								<input value="Delete" class="btn btn-primary" name="supprimer" type="submit">
							</form>
					</div>
					<div>
		<?php
