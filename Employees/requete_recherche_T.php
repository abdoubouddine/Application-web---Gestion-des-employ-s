<?php
session_start();
setcookie('temps',$_POST['temps'],time()+365*24*3600,null,null,false,true);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
					...
					<div class="row center">
						...
						if (isset($_POST['chercher']))
						 {	
							...
							$rep=$bd->prepare("SELECT * FROM employees WHERE TEMPS=?");
							$rep->execute(array($_POST['temps']));
	...
	if($c==0)
	{
		header('Location: rechercheD.php?error=1');
	}
	?>
</body>
</html>